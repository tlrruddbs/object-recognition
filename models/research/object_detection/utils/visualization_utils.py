...
def visualize_boxes_and_labels_on_image_array(
  ...
  # ikhwan , kyungsik variable
  global check_ikhwan_id
  global check_ikhwan_face
  global check_kyungsik_id
  global check_kyungsik_face

  check_ikhwan_id=0
  check_ikhwan_face=0
  check_kyungsik_face=0
  check_kyungsik_id=0
          ...
          if not agnostic_mode:
            if classes[i] in category_index.keys():
              ...
              if str1=="ikhwan_face":
                ...
                check_ikhwan_id = 1
              elif str1== "kyungsik_face":
                check_kyungsik_face = 1
              elif str1== "kyungsik_id":
                check_kyungsik_id = 1
              ...
              curs.execute("UPDATE employees set attendance=1 where name='"+str1+"'")
              conn.commit()
  ...
  #welcome sound go go go 
  if check_kyungsik_face==check_kyungsik_id==1:
    print(' welcome kyungsik ')
    conn.commit()

  if check_ikhwan_face==check_ikhwan_id==1:
    print(' welcome ikhwan' )
    conn.commit()
